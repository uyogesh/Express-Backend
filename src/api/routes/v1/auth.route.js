...
router.param('userName', controller.loadUsername)
/**
...
/**
 * @api {get} v1/auth/username/:userName
 * @apiDescription check if given Username is already taken
 * 
 * @apiQuery {String} username    username to check
 * 
 * @apiSuccess {String}   success   username is unique
 * 
 * @apiError (Unprocesable Entity 403 )   Unprocessable Entity    Username Already Exists
 * 
 * 
 */
